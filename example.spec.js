...
//Login vào TKT
    ...
    // await fileChooser.setFiles('c:/Users/USER/Downloads/nga2.csv'); // Đổi đường dẫn file cho phù hợp
   ...
   await page.waitForTimeout(2000)
    ...
    const searchInput = await page.locator("//input[@placeholder='Find by File name']");
    await searchInput.click();
    // Ví dụ: nhập từ khóa tìm kiếm
    await searchInput.fill('nga2.csv');
    await page.waitForTimeout(2000);
    ...
    await page.locator("//div[contains(@class,'ant-select-item-option') and @title='Created']").click();
